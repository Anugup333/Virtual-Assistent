...
# Image 
Display_Image = ImageTk.PhotoImage(Image.open("image/assistent.png"))
...
# Add a text button1
button1 =  Button(root,  text="ASK" , bg="#356666", pady=16 ,  padx=40,  borderwidth=3 ,activebackground='brown', command=ask)
button1.place(x= 70, y= 575)

# Add a text button2
button2 =  Button(root,  text="Send" , bg="#356666" , pady=16 ,  padx=40,  borderwidth=3,activebackground='brown' ,  command=User_send)
button2.place(x= 400, y= 575)

# Add a text button3
button3 = Button(root, text="Delete", bg="#356666" , pady=16 ,  padx=40,  borderwidth=3 ,activebackground='brown' ,command=delete_text)
